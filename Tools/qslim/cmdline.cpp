/************************************************************************
  ...
  $Id: cmdline.cpp,v 1.2 2006/09/20 17:41:08 marc Exp $
...
static std::string options = "O:B:W:t:Fo:m:c:rjI:M:T:qh";
...
"-T <format>    Select input format:\n"
"                       {mef, smf}\n"
"-M <format>    Select output format:\n"
"                       {mef, smf, iv, vrml, pm, mmf, log}\n"
"-q		Be quiet.\n"
...
static void usage_error(const std::string& msg)
{
  if( !msg.empty() )  cerr << "Error: " << msg << endl;
  print_usage();
  exit(1);
}
...
void process_cmdline(int argc, char **argv)
{
	...
	case 'M':
        ...
        case 'T':
	    if( !select_input_format(optarg) )
		usage_error("Unknown input format selected.");
	    break;
